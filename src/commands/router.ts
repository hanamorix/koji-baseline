...
import { handleHelp, handleTheme, handleLlm, handleVersion, handleAgent, handleExit, handleFont, handleCursor, handleShellIntegration, handleTerminfo, handleBlocks, handleHistory } from "./handlers";
